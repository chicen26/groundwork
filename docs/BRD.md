...
**Problem.** California tells homeowners two contradictory things about the same yard: the pending Zone 0 regulation (draft April 2026, possibly effective late 2026) requires stripping vegetation, mulch, and combustibles from the 0–5 ft perimeter of homes in Very High fire hazard zones, while state and local water policy pays homeowners $1–$2/sq ft to *replace* lawns with plants. In February 2025, CAL FIRE's new hazard maps put Very High zones inside 12 Contra Costa cities (incl. Danville, Concord, Lafayette, Orinda). Insurers are non-renewing policies while the state's *Safer from Wildfires* regulation entitles homeowners to premium credits for documented mitigation. No tool exists that reconciles these: commercial defensible-space AI (ZestyAI, Verisk) serves insurers via aerial imagery; Fire Aside serves fire-department inspectors. **No tool reconciles the two policies.** (Re-checked Aug 5, 2026.) Commercial defensible-space AI (ZestyAI, Verisk) serves insurers via aerial imagery; Fire Aside serves fire-department inspectors. On the consumer side, [firerisk.ai](https://firerisk.ai/defensible-space) offers a free mitigation plan with grant flags and contractor referrals, and Frontline's free app carries a defensible-space checklist — so "no consumer defensible-space tool exists" is **not** a claim we can make. What none of them do is reconcile Zone 0 clearance with lawn-replacement rebates, or let a homeowner photograph their own yard and get hazard detection from ground-level images. **Re-verify firerisk.ai's feature set before the video.**
...
**For judges:**
1. **The unclaimed intersection** — California tells you to strip the first five feet and pays you to plant. Nobody reconciles those two policies for a homeowner. Photo-based hazard detection from a homeowner's own camera is separately unclaimed on the consumer side; the capability is sold to insurers and fire departments via aerial imagery.
